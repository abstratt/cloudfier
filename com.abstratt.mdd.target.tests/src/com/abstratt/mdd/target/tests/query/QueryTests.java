...
public class QueryTests extends AbstractRepositoryBuildingTests {
    ...
    public void testActionBasedQuery() throws CoreException, IOException {
        ...
        source += "      begin\n";
        source += "          return (Class1 extent.select((a : Class1) : Boolean { true }).select((b : Class1) : Boolean { true }).collect((c : Class1) : Class2 { c->attr1 }) as Class2).select((d : Class2) : Boolean { true }).select((e : Class2) : Boolean { true });\n";
        source += "      end;\n";
        source += "  end;\n";
        source += "  class Class2\n";
        source += "  end;\n";
