...
public class POJOBehaviorTests extends AbstractRepositoryBuildingTests {
	...
	public void testGetProperty() throws CoreException {
		...
		Operation getBalanceOperation = getRepository().findNamedElement(
				"simple::Account::getBalance",
	...
	public void testAccessEnumValue() throws CoreException {
		...
		source += "end.";
		parseAndCheck(source);
		Operation getEnumValue = getRepository().findNamedElement(
				"simple::AClass::getEnumValue",
				UMLPackage.Literals.OPERATION, null);
