...
import com.abstratt.kirra.mdd.rest.impl.v1.representation.ActionJSONRepresentation;
import com.abstratt.kirra.mdd.rest.impl.v1.representation.QueryJSONRepresentation;
import com.abstratt.kirra.mdd.rest.impl.v1.representation.ServiceJSONRepresentation;
    ...
    public Representation getService() {
        ...
        for (Operation operation : service.getOperations()) {
            ...
            case Retriever:
                ...
                queryRepr.uri = reference.getParentRef().getParentRef().addSegment(com.abstratt.mdd.frontend.web.Paths.RETRIEVERS)
            ...
            case Event:
                ...
                actionRepr.uri = reference.getParentRef().getParentRef().addSegment(com.abstratt.mdd.frontend.web.Paths.EVENTS)
                        .addSegment(entityNamespace + '.' + entityName).addSegment(operation.getName()).toString();
