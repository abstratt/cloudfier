    ...
    grammar: {
      patterns: [
          ...
          {  
             ...
             match: '\\b(abstract|access|actor|aggregation|alias|all|allow|and|any|apply|association|as|attribute|begin|broadcast|by|call|catch|class|component|composition|connector|constructor|create|datatype|delete|deny|dependency|derived|destroy|do|else|elseif|end|entry|enumeration|exit|extends|extent|external|false|final|finally|function|id|if|implements|import|in|initial|inout|interface|invariant|is|link|literal|load|model|navigable|new|none|nonunique|not|null|on|operation|opposite|or|ordered|out|package|parameterset|port|postcondition|precondition|private|primitive|profile|property|protected|provided|public|query|raise|raises|read|readonly|reception|reference|repeat|required|return|role|self|send|signal|specializes|state|statemachine|static|stereotype|subsets|terminate|then|to|transition|true|try|type|unique|unlink|unordered|until|update|var|when|where|while)\\b'
          },
          {
