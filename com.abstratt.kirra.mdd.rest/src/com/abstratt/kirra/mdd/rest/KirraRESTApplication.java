...
public class KirraRESTApplication extends Application {
	...
	public Restlet createInboundRoot() {
		...
		attachTo(router, "/{workspace}/" + Paths.LOGIN, loginLogout);
		attachTo(router, "/{workspace}/" + Paths.LOGOUT, loginLogout);
		attachTo(router, "/{workspace}/" + Paths.PROFILE,
				createRestlet(ProfileResource.class));
		attachTo(router, "/{workspace}/" + Paths.ENTITIES + "/",
				createRestlet(EntityListResource.class));
		attachTo(router, "/{workspace}/" + Paths.ENTITIES + "/{entityNamespace}.{entityName}",
				createRestlet(EntityResource.class));
		attachTo(router, "/{workspace}/" + Paths.SERVICES + "/",
				createRestlet(ServiceListResource.class));
		attachTo(router, "/{workspace}/" + Paths.SERVICES + "/{entityNamespace}.{entityName}",
				createRestlet(ServiceResource.class));
		attachTo(router, "/{workspace}/" + Paths.INSTANCES + "/{entityNamespace}.{entityName}/",
				createRestlet(InstanceListResource.class));
		attachTo(router, "/{workspace}/" + Paths.FINDERS + "/{entityNamespace}.{entityName}/{finderName}",
				createRestlet(FinderResultResource.class));
		attachTo(router, "/{workspace}/" + Paths.RETRIEVERS + "/{entityNamespace}.{entityName}/{retrieverName}",
				createRestlet(ServiceInvocationResource.class));
		attachTo(router, "/{workspace}/" + Paths.ACTIONS + "/{entityNamespace}.{entityName}/{actionName}",
				createRestlet(StaticActionResource.class));		
		attachTo(router, "/{workspace}/" + Paths.INSTANCES + "/{entityNamespace}.{entityName}/{objectId}",
				createRestlet(InstanceResource.class));
		attachTo(router, "/{workspace}/" + Paths.INSTANCES + "/{entityNamespace}.{entityName}/{objectId}/" + Paths.RELATIONSHIPS + "/{relationshipName}/" + Paths.DOMAIN,
				createRestlet(RelationshipDomainResource.class));
		attachTo(router, "/{workspace}/" + Paths.INSTANCES + "/{entityNamespace}.{entityName}/{objectId}/" + Paths.RELATIONSHIPS + "/{relationshipName}/{relatedId}",
				createRestlet(RelatedInstanceResource.class));
		attachTo(router, "/{workspace}/" + Paths.INSTANCES + "/{entityNamespace}.{entityName}/{objectId}/" + Paths.ACTIONS + "/{actionName}",
				createRestlet(InstanceActionResource.class));
		attachTo(router, "/{workspace}/" + Paths.INSTANCES + "/{entityNamespace}.{entityName}/{objectId}/" + Paths.ACTIONS + "/{actionName}/" + Paths.PARAMETERS + "/{parameterName}/" + Paths.DOMAIN,
				createRestlet(ParameterDomainResource.class));
		attachTo(router, "/{workspace}/" + Paths.INSTANCES + "/{entityNamespace}.{entityName}/{objectId}/" + Paths.RELATIONSHIPS + "/{relationshipName}/",
				createRestlet(RelatedInstanceListResource.class));
		return router;
	}

	private void attachTo(Router router, String pathTemplate,
			Restlet resource) {
