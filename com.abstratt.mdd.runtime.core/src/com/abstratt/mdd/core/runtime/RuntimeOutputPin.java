 ...
 * <p>
 * &quot;<strong>11.3.27 OutputPin (from BasicActions)</strong> - 
 * An action cannot terminate itself if an output pin has fewer values than the 
 * lower multiplicity. An action may not put more values in an output pin in a 
 * single execution than the upper multiplicity of the pin.&quot;
 * </p>
 */
