...
//	public abstract ITypeInfo getTypeInfo();
	 ...
	 * <p>
	 * Does nothing by default. Subclasses that support the concept of active/inactive 
	...
	/**
	 * Converts model operation names to Java method names. By default, does nothing.
	 * 
	 * @param modelName the operation name as modeled
    ...
    /**
     *<p>Tries to invoke a Java method corresponding the given UML operation. If a suitable
     * method cannot be found, throws a corresponding checked exception. If the method can be found 
     * but execution fails, throws as runtime exception wrapping the original issue. Otherwise, if it succeeds,
     * returns the result of the invocation.
     */
	public static Object runNativeOperation(ExecutionContext context, Class javaClass, Object target, Operation operation, Object... arguments) {
		try {
