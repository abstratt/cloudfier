...
public abstract class RuntimeObjectNode {
	...
	/**
	 * <strong>12.3.38 ObjectNode (from BasicActivities, CompleteActivities)</strong> - &quot;An object node may not contain more tokens than its upper bound.&quot;
	 * @param newValue
	 */
	...
	public void basicSetValue(BasicType newValue) {
		//assert getUpperBound() == 1 || newValue instanceof CollectionType : instance.getName() + " - " + newValue.getClassifierName() + " - upper: " + getUpperBound();
	...
	/**
	 * Sets this node's value. This operation is illegal
	 * if the upper bound is greater than 1, or if a value has already
	 * been set.
	 * 
	 * @param the new value
	 */
	...
	public String toString() {
		return getClass().getSimpleName() + "@" + Integer.toHexString(System.identityHashCode(this)) + ": " + values.toString() + " - action: " + action;
	}
