...
public class KirraUIApplication extends LegacyKirraMDDRestletApplication {
	...
	public Restlet createInboundRoot() {
		...
		router.attach("/qooxdoo/framework/source/",
				new ClassLoaderDirectory(getContext(), new LocalReference("clap://thread/qooxdoo/framework/")));
		router.attach("/{workspace}/mobile/source/",
				new ClassLoaderDirectory(getContext(), new LocalReference("clap://thread/qooxdoo_mobile/source/")));
		router.attach("/qooxdoo_mobile/framework/source/",
				new ClassLoaderDirectory(getContext(), new LocalReference("clap://thread/qooxdoo_mobile/framework/")));
