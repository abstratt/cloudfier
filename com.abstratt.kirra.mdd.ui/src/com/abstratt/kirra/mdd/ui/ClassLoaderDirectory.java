...
public class ClassLoaderDirectory extends Directory {
	...
	public void handle(Request request, Response response) {
		...
		ResourceUtils.ensure(StringUtils.isBlank(workspace) || KirraRESTUtils.doesWorkspaceExist(workspace), "Application not found: " + workspace, Status.CLIENT_ERROR_NOT_FOUND);
