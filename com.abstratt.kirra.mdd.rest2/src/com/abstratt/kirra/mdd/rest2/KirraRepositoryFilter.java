...
//		Reference originalResourceReference = request.getResourceRef();
//		Reference modifiedReference = originalResourceReference.clone();
//		modifiedReference.setBaseRef(new Reference(modifiedReference.getBaseRef().toUri().resolve("..")));
//		List<String> modifiedSegments = originalResourceReference.getSegments();
//		modifiedSegments.remove(0);
//		modifiedReference.setSegments(modifiedSegments);
//		request.setResourceRef(modifiedReference);
		try {
