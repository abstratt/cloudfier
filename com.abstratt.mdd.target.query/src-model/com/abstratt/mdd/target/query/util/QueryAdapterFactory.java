...
public class QueryAdapterFactory extends AdapterFactoryImpl {
    ...
    public QueryAdapterFactory() {
        if (QueryAdapterFactory.modelPackage == null) {
            QueryAdapterFactory.modelPackage = QueryPackage.eINSTANCE;
        }
    }
    ...
    /**
     * Creates a new adapter for an object of class '
     * {@link org.eclipse.uml2.uml.NamedElement <em>Named Element</em>}'. <!--
     * begin-user-doc --> This default implementation returns null so that we
     * can easily ignore cases; it's useful to ignore a case when inheritance
     * will catch all the cases anyway. <!-- end-user-doc -->
     * 
    ...
    /**
     * Creates a new adapter for an object of class '
     * {@link org.eclipse.uml2.uml.PackageableElement
     * <em>Packageable Element</em>}'. <!-- begin-user-doc --> This default
    ...
    /**
     * Creates a new adapter for an object of class '
     * {@link org.eclipse.uml2.uml.ParameterableElement
     * <em>Parameterable Element</em>}'. <!-- begin-user-doc --> This default
     * implementation returns null so that we can easily ignore cases; it's
     * useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
     * 
     ...
     * <em>Property Reference</em>}'. <!-- begin-user-doc --> This default
     * implementation returns null so that we can easily ignore cases; it's
     * useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * Creates a new adapter for an object of class '
     * {@link org.eclipse.uml2.uml.TypedElement <em>Typed Element</em>}'. <!--
     * begin-user-doc --> This default implementation returns null so that we
     * can easily ignore cases; it's useful to ignore a case when inheritance
     * will catch all the cases anyway. <!-- end-user-doc -->
     * 
     ...
     * <em>Value Specification</em>}'. <!-- begin-user-doc --> This default
     * implementation returns null so that we can easily ignore cases; it's
     * useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
     * 
    ...
    public boolean isFactoryForType(Object object) {
        if (object == QueryAdapterFactory.modelPackage) {
            return true;
        }
        if (object instanceof EObject) {
            return ((EObject) object).eClass().getEPackage() == QueryAdapterFactory.modelPackage;
        }
        return false;
    }
