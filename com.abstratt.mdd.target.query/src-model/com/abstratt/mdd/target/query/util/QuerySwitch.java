	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case QueryPackage.PROPERTY_REFERENCE: {
				...
				if (result == null) result = caseValueSpecification(propertyReference);
				if (result == null) result = casePackageableElement(propertyReference);
				if (result == null) result = caseTypedElement(propertyReference);
				if (result == null) result = caseNamedElement(propertyReference);
				if (result == null) result = caseParameterableElement(propertyReference);
				if (result == null) result = caseElement(propertyReference);
				if (result == null) result = caseEModelElement(propertyReference);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case QueryPackage.VARIABLE_REFERENCE: {
				...
				if (result == null) result = caseValueSpecification(variableReference);
				if (result == null) result = casePackageableElement(variableReference);
				if (result == null) result = caseTypedElement(variableReference);
				if (result == null) result = caseNamedElement(variableReference);
				if (result == null) result = caseParameterableElement(variableReference);
				if (result == null) result = caseElement(variableReference);
				if (result == null) result = caseEModelElement(variableReference);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
