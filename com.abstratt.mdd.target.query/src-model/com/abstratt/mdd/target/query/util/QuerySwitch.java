...
public class QuerySwitch<T> extends Switch<T> {
     ...
     */
    public QuerySwitch() {
        if (QuerySwitch.modelPackage == null) {
            QuerySwitch.modelPackage = QueryPackage.eINSTANCE;
        }
    }
    ...
    /**
     * Returns the result of interpreting the object as an instance of '
     * <em>Packageable Element</em>'. <!-- begin-user-doc --> This
    ...
    /**
     * Returns the result of interpreting the object as an instance of '
     * <em>Parameterable Element</em>'. <!-- begin-user-doc --> This
     * implementation returns null; returning a non-null result will terminate
     * the switch. <!-- end-user-doc -->
     * 
     * @param object
    ...
    /**
     * Returns the result of interpreting the object as an instance of '
     * <em>Value Specification</em>'. <!-- begin-user-doc --> This
     * implementation returns null; returning a non-null result will terminate
     * the switch. <!-- end-user-doc -->
     * 
     * @param object
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        ...
        case QueryPackage.JOIN: {
            ...
            if (result == null)
                result = caseElement(join);
            if (result == null)
                result = caseEModelElement(join);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case QueryPackage.PROPERTY_REFERENCE: {
            ...
            if (result == null)
                result = caseValueSpecification(propertyReference);
            if (result == null)
                result = casePackageableElement(propertyReference);
            if (result == null)
                result = caseTypedElement(propertyReference);
            if (result == null)
                result = caseNamedElement(propertyReference);
            if (result == null)
                result = caseParameterableElement(propertyReference);
            if (result == null)
                result = caseElement(propertyReference);
            if (result == null)
                result = caseEModelElement(propertyReference);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case QueryPackage.VARIABLE_REFERENCE: {
            ...
            if (result == null)
                result = caseValueSpecification(variableReference);
            if (result == null)
                result = casePackageableElement(variableReference);
            if (result == null)
                result = caseTypedElement(variableReference);
            if (result == null)
                result = caseNamedElement(variableReference);
            if (result == null)
                result = caseParameterableElement(variableReference);
            if (result == null)
                result = caseElement(variableReference);
            if (result == null)
                result = caseEModelElement(variableReference);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
    ...
    protected boolean isSwitchFor(EPackage ePackage) {
        return ePackage == QuerySwitch.modelPackage;
    }
