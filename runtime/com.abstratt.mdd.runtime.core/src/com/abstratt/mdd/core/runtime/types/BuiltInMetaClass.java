...
public enum BuiltInMetaClass implements MetaClass<BuiltInClass> {
    System("mdd_types::System", SystemType.class), Assert("mdd_types::Assert", AssertType.class), Console("mdd_console::Console", ConsoleType.class), 
    		Boolean("mdd_types::Boolean", BooleanType.class), Integer("mdd_types::Integer", IntegerType.class), Decimal("mdd_types::Double", RealType.class), String(
            "mdd_types::String", StringType.class), Memo("mdd_types::Memo", MemoType.class), Image("mdd_media::Image", PictureType.class), Duration("mdd_types::Duration", DurationType.class), Date("mdd_types::Date", DateType.class), Set(
