...
public class AbstractKirraMDDRuntimeTests extends AbstractRuntimeTests {
    ...
    protected List<?> executeKirraOperation(String namespace, String entityOrService, String objectId, String operationName,
            List<?> arguments) throws CoreException {
        ...
        TestCase.assertNotNull("No " + operationName + " in " + targetType.getTypeRef(), operation);
