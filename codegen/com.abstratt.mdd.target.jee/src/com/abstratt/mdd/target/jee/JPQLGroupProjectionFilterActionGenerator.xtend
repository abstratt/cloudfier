 ...
 */
class JPQLGroupProjectionFilterActionGenerator extends JPQLFilterActionGenerator {
    ...
    def override CharSequence generateReadPropertyAction(ReadStructuralFeatureAction action) {
        ...
        new JPQLGroupProjectionActionGenerator(repository).generateAction(attributeSource)
    }
}