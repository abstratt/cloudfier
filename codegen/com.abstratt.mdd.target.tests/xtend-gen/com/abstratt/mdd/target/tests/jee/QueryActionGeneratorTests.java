...
public class QueryActionGeneratorTests extends AbstractGeneratorTest {
  ...
  public void testGroupByAttributeIntoCount() throws CoreException, IOException {
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("model crm;");
    _builder.newLine();
    _builder.append("class Customer");
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("query countByTitle() : {title : String, customerCount : Integer} [*];");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("begin");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("return Customer extent.groupBy((c : Customer) : String {");
    _builder.newLine();
    _builder.append("            ");
    _builder.append("c.title");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("}).groupCollect((group : Customer[*]) : {title:String, customerCount : Integer} {");
    _builder.newLine();
    _builder.append("            ");
    _builder.append("{ ");
    _builder.newLine();
  ...
  public void testGroupByAttributeIntoSum() throws CoreException, IOException {
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("model crm;");
    _builder.newLine();
    _builder.append("class Customer");
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("query sumSalaryByTitle() : {title : String, totalSalary : Double} [*];");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("begin");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("}).groupCollect((grouped : Customer[*]) : {title : String, totalSalary : Double} {");
    _builder.newLine();
    _builder.append("            ");
    _builder.append("{ ");
    _builder.newLine();
    _builder.append("                ");
    _builder.append("title := grouped.one().title,");
    _builder.newLine();
    _builder.append("                ");
    _builder.append("totalSalary := grouped.sum((c : Customer) : Double {");
    _builder.newLine();
    _builder.append("                    ");
    _builder.append("c.salary");
    _builder.newLine();
    _builder.append("                ");
    _builder.append("})");
    _builder.newLine();
    ...
    String source = _builder.toString();
    this.parseAndCheck(source);
    final Operation op = this.getOperation("crm::Customer::sumSalaryByTitle");
    final Action root = this.getStatementSourceAction(op);
    IRepository _repository = this.getRepository();
    QueryActionGenerator _queryActionGenerator = new QueryActionGenerator(_repository);
    final CharSequence generated = _queryActionGenerator.generateAction(root);
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append(".multiselect(customer_.get(\"title\"), cb.sum(customer_.get(\"salary\")))");
    _builder_1.newLine();
    String _string = generated.toString();
    AssertHelper.assertStringsEqual(_builder_1.toString(), _string);
  }
