...
public class RuntimeExternalTests extends AbstractRuntimeTests {
    ...
    public void testInvokeExternalOperation() throws CoreException {
        ...
        IntegerType result = (IntegerType) runOperation(getRuntime().getInstance(externalClass), "someOperation", new IntegerType(30),
                new IntegerType(12));
        TestCase.assertEquals(IntegerType.fromValue(42), result);
    }
    ...
    public void testSendSignalToExternalObject() throws CoreException {
        ...
        getRuntime().registerExternalDelegate(new ExternalObjectDelegate() {
            ...
            public void receiveSignal(Classifier classifier, Signal received, Object... arguments) {
                ...
                TestCase.assertTrue(arguments[0] instanceof RuntimeObject);
        ...
        TestCase.assertEquals(IntegerType.fromValue(10), valueReceived);
    }
}
