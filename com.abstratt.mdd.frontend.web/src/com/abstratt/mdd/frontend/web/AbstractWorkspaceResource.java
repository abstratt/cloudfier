...
public abstract class AbstractWorkspaceResource extends ServerResource {
    ...
    protected static Log log = LogFactory.getLog(AbstractWorkspaceResource.class);
    ...
    protected String getSecret() {
        return StringUtils.trimToEmpty(getQuery().getValuesMap().get(AbstractWorkspaceResource.SECRET_PARAMETER));
    }
