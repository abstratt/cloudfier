...
public class PublisherApplication extends Application {
	...
	public Restlet createInboundRoot() {
		...
		router.attach(WebFrontEnd.PUBLISHER_SEGMENT + "{workspace}/",
				PublisherResource.class);
		router.attach(WebFrontEnd.PUBLISHER_SEGMENT + "{workspace}.zip",
				ArchiverResource.class);
		router.attach(WebFrontEnd.PUBLISHER_SEGMENT + "{workspace}/{file}",
				FileResource.class);
//		router.attach(WebFrontEnd.GENERATOR_SEGMENT + "{workspace}/{platform}",
//				GeneratorResource.class);
